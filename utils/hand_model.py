...
class HandModel:
    def __init__(
        ...
        self.vertices = {}
        removed_links = json.load(open(os.path.join(ROOT_DIR, 'data/urdf/removed_links.json')))[robot_name]
...
def create_hand_model(
    ...
    json_path = os.path.join(ROOT_DIR, 'data/urdf/urdf_assets_meta_extended.json')
