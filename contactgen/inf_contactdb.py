...
from contactgen.datasets.eval_dataset_contactdb import TestSetContactDB
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root', default='../human_contact/contactdb', type=str, help='result save root')
